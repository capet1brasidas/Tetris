...
public abstract class GameBase implements ApplicationListener {
    //constants
//    private static final Logger log=new Logger(GameBase.class.getName(),Logger.DEBUG);
...
//        log.debug("setting screen to= "+screen);
//        log.debug("transitionInProgress= "+transitionInProgress);
//
//        log.debug("currentScreen==screen => "+(currentScreen==screen));
//
//        log.debug("nextScreen==null => "+(nextScreen==null));
...
//        }
        ...
        //disable input processors later enabled when trasition is finished
    ...
    public void render() {
        ...
        if(nextScreen==null) {
            //no transition
//            log.debug("next screen is null");
            if (currentScreen != null) {
//                log.debug("render succeeded");
                currentScreen.render(delta);
//                log.debug("render ends");
            }
        }else {
//                log.debug("next screen is not null");
